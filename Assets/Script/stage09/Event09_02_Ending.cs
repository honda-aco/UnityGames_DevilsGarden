...
{
    public class Event09_02_Ending : Event_DeferredBgm
    {
        private EventController09 eventController09;

        public Event09_02_Ending(EventController09 eventController) : base(eventController)
        {
        ...
        private bool event1()
        {
            eventController09.loadScene(@"stage_end05");
            Charactor.Restart();
            return true;
        }
    }
