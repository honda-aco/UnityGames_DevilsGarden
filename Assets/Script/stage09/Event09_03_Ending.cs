...
{
    public class Event09_03_Ending : Event_DeferredBgm
    {
        private EventController09 eventController09;

        public Event09_03_Ending(EventController09 eventController) : base(eventController)
        {
        ...
        private bool event1()
        {
            eventController09.loadScene(@"stage_end06");
            Charactor.Restart();
            return true;
        }
    }
