...
{
    public class Event05_03_MoveScene : Event_MoveScene
    {
        private EventController05 eventController05;

        public Event05_03_MoveScene(EventController05 eventController) : base(eventController)
        {
        ...
        {
            eventController05.loadScene(@"stage07");
        }
    }
}